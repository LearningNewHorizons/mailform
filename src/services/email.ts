...
export class EmailService {
     ...
     */
    public static async sendMail(targetName: string, from: string, fieldreplyTo: string, subject: string, body: string, files: FormidableFiles): Promise<boolean|Error> {
